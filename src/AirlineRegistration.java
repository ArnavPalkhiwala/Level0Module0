...
public class AirlineRegistration {
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, birthdayMonth + "/" + birthdayDay + "/" + birthdayYear);
		JOptionPane.showMessageDialog(null, "Row" + ": " + rowNumber);
		JOptionPane.showMessageDialog(null, "Seat" + ": " + seatNumber);
